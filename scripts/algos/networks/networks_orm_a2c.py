...
class StochasticActor(GaussianMixin, Model):
    def __init__(self, observation_space, action_space, device,
                 ...
                 clip_actions=False, clip_log_std=True, min_log_std=-5, max_log_std=2, use_graph=True, task_out=64):
        ...
        mlp_in = task_out # img_dim + graph_dim + img + graph_emb + pred_angle
        self.net = MLP(
            input_dim=mlp_in,
    ...
    def compute(self, inputs, role):
        ...
        # x = torch.cat([img, goal, gt_orientation], dim=-1)
...
class Critic(DeterministicMixin, Model):
    def __init__(self, observation_space, action_space, device,
        ...
        mlp_in = task_out # img_dim + graph_dim + self.num_actions + 
        self.net = MLP(
            input_dim=mlp_in,
            output_dim=1,
        )
